...
from sample_generation.sensitivity_study_sample import Sampling
...
if os_name == 'Linux':
    parent_path = "//home//anais//Sensitivity_Study"
    ...
    parent_path = "C://Users//anais.habermann//Desktop//Sensitivity_Study"
    default_case_path = "..//..//..//hybrid_method//default_fv_case//fully_resolved"
...
with open(f"{parent_path}//study.log","w",newline="") as logfile:
    ...
    """CREATE SAMPLE"""
    sample = Sampling(5)
    individual_sims, _, _ = sample.create_sample()
    ...
    for i in range(0, len(individual_sims)):
        ...
        try:
            ...
            tc_max_x, c_nac, i_nac, teta_f_aft, Astar_A2, _,x_12, x_13,rotor_le_coeffs, stator_le_coeffs, h_duct_in, h_duct_out, A_12, A_13, A_18, x_nac_max  \
            ...
            geomkeys = ['geotype','x_ff','r_cent_f','l_cent_f','rmax','f_xmax','lnac','h_duct','f_r12','f_lint',
                        'teta_f_cone','f_rho_le','f_l_nose','ahi_athr','athr_a12','a18_a13','f_xthr','delta_beta_te',
                        'beta_te_low','f_r18hub','f_rthrtip', 'teta_int_in','teta_ff_in', 'beta_ff_in','mach_number',
                        'altitude','omega_rot']
            geom_data_row = ['generateGeomBFM_sensitivity_ICST', individual_sims[i]['x_ff'],
                                      individual_sims[i]['r_cent_f'], individual_sims[i]['l_cent_f'], individual_sims[i]['rmax'],
                                          individual_sims[i]['f_xmax'], individual_sims[i]['lnac'],
        ...
        try:
            ...
            geometry = {'fuselage': fuselage, 'nacelle_top': nacelle_top, 'nacelle_bottom': nacelle_bottom,
                        ...
                        'A_12': A_12, 'A_13': A_13, 'A_18': A_18, 'x_nac_max': x_nac_max}
